"""Remove quick_replies column from shops table

Revision ID: 39e9315072bf
Revises: 3fa82699e22b
Create Date: 2025-07-11 20:29:31.809011
...
revision: str = '39e9315072bf'
down_revision: Union[str, None] = '3fa82699e22b'
...
def upgrade() -> None:
    ...
    op.drop_column('shops', 'quick_replies')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('shops', sa.Column('quick_replies', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
