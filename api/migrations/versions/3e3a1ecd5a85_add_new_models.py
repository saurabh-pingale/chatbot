...
Revision ID: 3e3a1ecd5a85
Revises: 0ad08f87380b
Create Date: 2025-06-15 17:54:10.627959
...
revision: str = '3e3a1ecd5a85'
down_revision: Union[str, None] = '0ad08f87380b'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('uq_user_shop_date', table_name='user_shop_analytics', postgresql_where=sa.text('user_id IS NOT NULL'))
    op.drop_index('uq_guest_shop_date', table_name='user_shop_analytics', postgresql_where=sa.text('guest_id IS NOT NULL'))
    ...
    op.drop_table('user_shop_analytics')
