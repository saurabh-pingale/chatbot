"""Add FK to variant_id

Revision ID: 25e8bd51ba4a
Revises: d120dbfe3a1a
Create Date: 2025-07-22 17:21:16.322354
...
revision: str = '25e8bd51ba4a'
down_revision: Union[str, None] = 'd120dbfe3a1a'
...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_checkout_products_variant_id', 'checkout_products', 'products', ['variant_id'], ['variant_id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'checkout_products', type_='foreignkey')
