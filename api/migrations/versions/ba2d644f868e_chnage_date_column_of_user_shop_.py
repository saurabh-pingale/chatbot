"""Chnage date column of user_shop_analytics table to BigInteger

Revision ID: ba2d644f868e
Revises: 655bc24dcb8d
Create Date: 2025-07-22 12:51:29.472300
...
revision: str = 'ba2d644f868e'
down_revision: Union[str, None] = '655bc24dcb8d'
...
def upgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE user_shop_analytics ALTER COLUMN date TYPE BIGINT USING EXTRACT(EPOCH FROM date);"
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(
        "ALTER TABLE user_shop_analytics ALTER COLUMN date TYPE DATE USING TO_TIMESTAMP(date)::DATE;"
    )
