"""Add quick_replies column to shops

Revision ID: 3fa82699e22b
Revises: 148b99ba8196
Create Date: 2025-07-02 15:29:55.389757
...
revision: str = '3fa82699e22b'
down_revision: Union[str, None] = '148b99ba8196'
...
def upgrade() -> None:
    ...
    op.add_column('shops', sa.Column('quick_replies', sa.JSON(), nullable=True))
