...
Revision ID: b04d4a8281fc
Revises: af1d8549c06f
Create Date: 2025-06-25 13:06:31.860316
...
revision: str = 'b04d4a8281fc'
down_revision: Union[str, None] = 'af1d8549c06f'
...
def upgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('ACTIVE', 'CANCELED', 'PAST_DUE', 'INCOMPLETE', 'INCOMPLETE_EXPIRED', 'TRIALING', 'UNPAID', name='subscriptionstatus', create_type=False), nullable=False),
