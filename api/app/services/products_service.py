...
class ProductsService:
    ...
    async def create(self, namespace: str) -> Dict[str, Any]:
        ...
        try:
            ...
            stored_collections = await self.store_admin_handler.store_collections(collections)

            collection_id_map = {
                collection["title"]: collection["id"] for collection in stored_collections
            }

            await self.store_admin_handler.store_products(products, collection_id_map)
